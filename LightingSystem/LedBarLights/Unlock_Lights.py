...
grovepi.ledBar_setLed(rightledbar, 10, 1)
grovepi.ledBar_setLed(leftledbar, 10, 1)

time.sleep(.5)

grovepi.ledBar_setLed(rightledbar, 10, 0)
grovepi.ledBar_setLed(leftledbar, 10, 0)
