...
for x in range(0, number_of_blinks):
    ...
    sense.set_pixel(1, 0, 255, 191, 0)
    sense.set_pixel(2, 0, 255, 191, 0)
    ...
    sense.set_pixel(7, 2, 255, 191, 0)
    sense.set_pixel(6, 4, 255, 191, 0)
    #sense.set_pixel(0, 5, 255, 191, 0)
    sense.set_pixel(0, 4, 255, 191, 0)
    sense.set_pixel(1, 5, 255, 191, 0)
    sense.set_pixel(2, 6, 255, 191, 0)
    sense.set_pixel(7, 5, 255, 191, 0)
    sense.set_pixel(7, 6, 255, 191, 0)
