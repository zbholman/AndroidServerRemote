...
class Monitor:
    ...
    def __init__(self):
        ...
        def ConvertFromJSON(json_string):
            ...
            return Message(contents['CID'], contents['OID'], contents['DID'], contents['TS'], contents['TTL'], contents['PLD'], contents['CKS'])
        ...
        messageList = ['{"CID": "car10393", "DID": "brs", "CKS": "8fcffdcd1c1dbd62c199aa2a13c9043a", "TTL": 100, "OID": "ccs", "PLD": "payload: This message format defined by subteams", "TS": "12:42:213"}',
                       '{"CID": "car10393", "DID": "mls", "CKS": "8fcffdcd1c1dbd62c199aa2a13c9043a", "TTL": 100, "OID": "ccs", "PLD": "payload: This message format defined by subteams", "TS": "12:42:747"}', 
                       '{"CID": "car10393", "DID": "dts", "CKS": "8fcffdcd1c1dbd62c199aa2a13c9043a", "TTL": 100, "OID": "ccs", "PLD": "payload: This message format defined by subteams", "TS": "12:42:343"}', 
                       '{"CID": "car10393", "DID": "ems", "CKS": "8fcffd1c1dbd62c199aa13c9043azdsd", "TTL": 100, "OID": "ccs", "PLD": "payload: This message format defined by subteams", "TS": "12:42:293"}' 
                       ]
